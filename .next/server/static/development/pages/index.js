...
const DELETE_POLL = graphql_tag__WEBPACK_IMPORTED_MODULE_6___default.a`
...
function Index(props) {
  ...
  const [deletePoll, deleteData] = Object(_apollo_react_hooks__WEBPACK_IMPORTED_MODULE_10__["useMutation"])(DELETE_POLL);
  const {
    loading,
    error,
    data
