...
function FormComponent(props) {
  ...
  var save = function save() {
    console.log("".concat(days[day], "/").concat(days[month], "/").concat(days[year]));
    var expiry = moment__WEBPACK_IMPORTED_MODULE_6___default()("".concat(days[day], "/").concat(days[month], "/").concat(days[year]), 'DD/MM/YYYY').format("YYYY-MM-DD HH:mm:ss"); // If we are updating
...
//# sourceMappingURL=update.js.6904e0995f0fba9b68b1.hot-update.js.map