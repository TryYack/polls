...
var closeAppModal = function closeAppModal(_ref) {
  var name = _ref.name,
      url = _ref.url;
  postAppMessage({
...
var closeAppPanel = function closeAppPanel(_ref2) {
  var name = _ref2.name,
      url = _ref2.url;
  postAppMessage({
    type: 'DISPATCH_APP_ACTION',
...
var openAppPanel = function openAppPanel(_ref3) {
  var name = _ref3.name,
      url = _ref3.url;
  postAppMessage({
    type: 'DISPATCH_APP_ACTION',
...
var openAppModal = function openAppModal(_ref4) {
  var name = _ref4.name,
      url = _ref4.url;
  postAppMessage({
    type: 'DISPATCH_APP_ACTION',
...
//# sourceMappingURL=message.js.5b6dd228d57633a6ea0d.hot-update.js.map