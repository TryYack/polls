...
function FormComponent(props) {
  ...
  var updateQuestion = function updateQuestion(value, index) {
    setQuestions(questions.map(function (question, i) {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_3___default.a.Fragment, {
    ...
    return __jsx("div", {
      ...
      inputSize: "large",
      onChange: function onChange(e) {
        return updateQuestion(e.target.value, index);
      },
      __source: {
        fileName: _jsxFileName,
        lineNumber: 96
...
//# sourceMappingURL=update.js.5081b560d1605c046745.hot-update.js.map