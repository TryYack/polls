...
function FormComponent(props) {
  ...
  var save = function save() {
    var expiry = moment__WEBPACK_IMPORTED_MODULE_6___default()("".concat(day, "/").concat(month, "/").concat(year), 'DD/MM/YYYY').format("YYYY-MM-DD HH:mm:ss"); // If we are updating
...
//# sourceMappingURL=create.js.1fca3f7079bbee42252d.hot-update.js.map